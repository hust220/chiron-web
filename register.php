...
$link = "http://" . $_SERVER['HTTP_HOST'] . '/chiron/emailconfirm.php'."?username=$username&key=".
...
$mail_subject = "Chiron new user registration notice";
$mail_message = "There is a new user registered to Chiron server\r\n username: $username \r\n" .
...
$send_to = '"Jian Wang" <jianopt@ad.unc.edu>, "Pradeep Kota" <pkota@email.unc.edu>, "Nikolay Dokholyan" <dokh@med.unc.edu>, "Srinivas Ramachandran" <ramachan@email.unc.edu>, "Feng Ding" <fding@email.unc.edu>';
